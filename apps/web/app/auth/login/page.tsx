    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 selection:bg-indigo-500 selection:text-white">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          ...
          <p className="text-xs text-slate-400">Enterprise Recruiter Command Center & Candidate Portal</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-2xl shadow-2xl border border-slate-800 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white font-bold rounded-xl shadow-lg shadow-indigo-600/30 transition duration-200 disabled:opacity-50 flex items-center justify-center space-x-2"
            >
